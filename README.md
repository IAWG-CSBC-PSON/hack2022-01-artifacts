...
## Considerations
1. Ground truth labels can themselves be inaccurate. How might classifiers be developed to guard against 1) artifact misclassification, 2) false positives (i.e. artifact-free cells inadvertently classified as noisy), and 3) false negatives (i.e. artifacts gone unannotated)?
